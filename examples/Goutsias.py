...
def Goutsias(Np):
    ...
    speciesScaleExponents = array([1,1,0,0,0,0])
    ...
    model_coupled.systemState[0,0] = 2.*pow(Np,g1)
    model_coupled.systemState[1,0] = 6.*pow(Np,g2)
    model_coupled.systemState[2,0] = 0.
    model_coupled.systemState[3,0] = 2.
    model_coupled.systemState[4,0] = 0.
    model_coupled.systemState[5,0] = 0.
    ...
    return model,model_hybrid,model_coupled
